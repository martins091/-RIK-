...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      <div className="absolute inset-0 bg-gradient-to-br from-[#8B0000] via-[#A52A2A] to-[#D4AF37] opacity-90"></div>

      <div className="absolute inset-0 bg-[url('/pattern.svg')] opacity-10"></div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <div className="mb-8 inline-block">
          <div className="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-full px-6 py-2 mb-6">
            <p className="text-sm font-semibold tracking-wider">GUINNESS WORLD RECORD ATTEMPT</p>
          </div>
        </div>
        ...
        <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto">
          Celebrating Nigeria's Rich Heritage Through Food, Culture & Entertainment
        </p>
        ...
        <div className="mb-12">
          ...
          <div className="flex justify-center gap-4 md:gap-8 flex-wrap">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 md:p-6 min-w-[80px] border border-white/20">
